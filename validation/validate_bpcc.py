...
Usage:
    uv run python -m validation.validate_bpcc
    uv run python -m validation.validate_bpcc --checkpoint .models/modernbert-chat-bpcc-translation/checkpoint-3609 --n 20
"""
